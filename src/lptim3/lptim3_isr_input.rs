#[doc = "Register `LPTIM3_ISR_INPUT` reader"]
pub type R = crate::R<Lptim3IsrInputSpec>;
...
#[doc = "LPTIM3 interrupt and status register \\[alternate\\]\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lptim3_isr_input::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lptim3IsrInputSpec;
impl crate::RegisterSpec for Lptim3IsrInputSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lptim3_isr_input::R`](R) reader structure"]
impl crate::Readable for Lptim3IsrInputSpec {}
#[doc = "`reset()` method sets LPTIM3_ISR_INPUT to value 0"]
impl crate::Resettable for Lptim3IsrInputSpec {
