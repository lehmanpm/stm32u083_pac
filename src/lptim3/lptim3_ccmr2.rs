#[doc = "Register `LPTIM3_CCMR2` reader"]
pub type R = crate::R<Lptim3Ccmr2Spec>;
#[doc = "Register `LPTIM3_CCMR2` writer"]
pub type W = crate::W<Lptim3Ccmr2Spec>;
...
#[doc = "Capture/compare 3 output enable. Condition: CC3 as output: Condition: CC3 as input: This bit determines if a capture of the counter value can actually be done into the input capture/compare register 3 (LPTIM3_CCR3) or not.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Cc3e {
...
#[doc = "Field `CC3E` reader - Capture/compare 3 output enable. Condition: CC3 as output: Condition: CC3 as input: This bit determines if a capture of the counter value can actually be done into the input capture/compare register 3 (LPTIM3_CCR3) or not."]
...
#[doc = "Field `CC3E` writer - Capture/compare 3 output enable. Condition: CC3 as output: Condition: CC3 as input: This bit determines if a capture of the counter value can actually be done into the input capture/compare register 3 (LPTIM3_CCR3) or not."]
...
#[doc = "Capture/compare 4 output enable. Condition: CC4 as output: Condition: CC4 as input: This bit determines if a capture of the counter value can actually be done into the input capture/compare register 4 (LPTIM3_CCR4) or not.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Cc4e {
...
#[doc = "Field `CC4E` reader - Capture/compare 4 output enable. Condition: CC4 as output: Condition: CC4 as input: This bit determines if a capture of the counter value can actually be done into the input capture/compare register 4 (LPTIM3_CCR4) or not."]
...
#[doc = "Field `CC4E` writer - Capture/compare 4 output enable. Condition: CC4 as output: Condition: CC4 as input: This bit determines if a capture of the counter value can actually be done into the input capture/compare register 4 (LPTIM3_CCR4) or not."]
...
impl R {
    ...
    #[doc = "Bit 1 - Capture/compare 3 output enable. Condition: CC3 as output: Condition: CC3 as input: This bit determines if a capture of the counter value can actually be done into the input capture/compare register 3 (LPTIM3_CCR3) or not."]
    #[inline(always)]
    ...
    #[doc = "Bit 17 - Capture/compare 4 output enable. Condition: CC4 as output: Condition: CC4 as input: This bit determines if a capture of the counter value can actually be done into the input capture/compare register 4 (LPTIM3_CCR4) or not."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc3sel(&mut self) -> Cc3selW<Lptim3Ccmr2Spec> {
        Cc3selW::new(self, 0)
    }
    #[doc = "Bit 1 - Capture/compare 3 output enable. Condition: CC3 as output: Condition: CC3 as input: This bit determines if a capture of the counter value can actually be done into the input capture/compare register 3 (LPTIM3_CCR3) or not."]
    #[inline(always)]
    #[must_use]
    pub fn cc3e(&mut self) -> Cc3eW<Lptim3Ccmr2Spec> {
        Cc3eW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Capture/compare 3 output polarity. Condition: CC3 as output: Only bit2 is used to set polarity when output mode is enabled, bit3 is don't care. Condition: CC3 as input: This field is used to select the IC3 polarity for capture operations."]
    #[inline(always)]
    #[must_use]
    pub fn cc3p(&mut self) -> Cc3pW<Lptim3Ccmr2Spec> {
        Cc3pW::new(self, 2)
    }
    #[doc = "Bits 8:9 - Input capture 3 prescaler This bitfield defines the ratio of the prescaler acting on the CC3 input (IC3)."]
    #[inline(always)]
    #[must_use]
    pub fn ic3psc(&mut self) -> Ic3pscW<Lptim3Ccmr2Spec> {
        Ic3pscW::new(self, 8)
    }
    #[doc = "Bits 12:13 - Input capture 3 filter This bitfield defines the number of consecutive equal samples that should be detected when a level change occurs on an external input capture signal before it is considered as a valid level transition. An internal clock source must be present to use this feature."]
    #[inline(always)]
    #[must_use]
    pub fn ic3f(&mut self) -> Ic3fW<Lptim3Ccmr2Spec> {
        Ic3fW::new(self, 12)
    }
    #[doc = "Bit 16 - Capture/compare 4 selection This bitfield defines the direction of the channel, input (capture) or output mode."]
    #[inline(always)]
    #[must_use]
    pub fn cc4sel(&mut self) -> Cc4selW<Lptim3Ccmr2Spec> {
        Cc4selW::new(self, 16)
    }
    #[doc = "Bit 17 - Capture/compare 4 output enable. Condition: CC4 as output: Condition: CC4 as input: This bit determines if a capture of the counter value can actually be done into the input capture/compare register 4 (LPTIM3_CCR4) or not."]
    #[inline(always)]
    #[must_use]
    pub fn cc4e(&mut self) -> Cc4eW<Lptim3Ccmr2Spec> {
        Cc4eW::new(self, 17)
    }
    #[doc = "Bits 18:19 - Capture/compare 4 output polarity. Condition: CC4 as output: Only bit2 is used to set polarity when output mode is enabled, bit3 is don't care. Condition: CC4 as input: This field is used to select the IC4 polarity for capture operations."]
    #[inline(always)]
    #[must_use]
    pub fn cc4p(&mut self) -> Cc4pW<Lptim3Ccmr2Spec> {
        Cc4pW::new(self, 18)
    }
    #[doc = "Bits 24:25 - Input capture 4 prescaler This bitfield defines the ratio of the prescaler acting on the CC4 input (IC4)."]
    #[inline(always)]
    #[must_use]
    pub fn ic4psc(&mut self) -> Ic4pscW<Lptim3Ccmr2Spec> {
        Ic4pscW::new(self, 24)
    }
    #[doc = "Bits 28:29 - Input capture 4 filter This bitfield defines the number of consecutive equal samples that should be detected when a level change occurs on an external input capture signal before it is considered as a valid level transition. An internal clock source must be present to use this feature."]
    #[inline(always)]
    #[must_use]
    pub fn ic4f(&mut self) -> Ic4fW<Lptim3Ccmr2Spec> {
        Ic4fW::new(self, 28)
    }
}
#[doc = "LPTIM capture/compare mode register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lptim3_ccmr2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lptim3_ccmr2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lptim3Ccmr2Spec;
impl crate::RegisterSpec for Lptim3Ccmr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lptim3_ccmr2::R`](R) reader structure"]
impl crate::Readable for Lptim3Ccmr2Spec {}
#[doc = "`write(|w| ..)` method takes [`lptim3_ccmr2::W`](W) writer structure"]
impl crate::Writable for Lptim3Ccmr2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPTIM3_CCMR2 to value 0"]
impl crate::Resettable for Lptim3Ccmr2Spec {
