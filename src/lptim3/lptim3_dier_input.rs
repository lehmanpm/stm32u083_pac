#[doc = "Register `LPTIM3_DIER_INPUT` reader"]
pub type R = crate::R<Lptim3DierInputSpec>;
#[doc = "Register `LPTIM3_DIER_INPUT` writer"]
pub type W = crate::W<Lptim3DierInputSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc1ie(&mut self) -> Cc1ieW<Lptim3DierInputSpec> {
        Cc1ieW::new(self, 0)
    }
    #[doc = "Bit 1 - Autoreload match Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn arrmie(&mut self) -> ArrmieW<Lptim3DierInputSpec> {
        ArrmieW::new(self, 1)
    }
    #[doc = "Bit 2 - External trigger valid edge Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn exttrigie(&mut self) -> ExttrigieW<Lptim3DierInputSpec> {
        ExttrigieW::new(self, 2)
    }
    #[doc = "Bit 4 - Autoreload register update OK Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn arrokie(&mut self) -> ArrokieW<Lptim3DierInputSpec> {
        ArrokieW::new(self, 4)
    }
    #[doc = "Bit 5 - Direction change to UP Interrupt Enable Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn upie(&mut self) -> UpieW<Lptim3DierInputSpec> {
        UpieW::new(self, 5)
    }
    #[doc = "Bit 6 - Direction change to down Interrupt Enable Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn downie(&mut self) -> DownieW<Lptim3DierInputSpec> {
        DownieW::new(self, 6)
    }
    #[doc = "Bit 7 - Update event interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ueie(&mut self) -> UeieW<Lptim3DierInputSpec> {
        UeieW::new(self, 7)
    }
    #[doc = "Bit 8 - Repetition register update OK interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn repokie(&mut self) -> RepokieW<Lptim3DierInputSpec> {
        RepokieW::new(self, 8)
    }
    #[doc = "Bit 9 - Capture/compare 2 interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cc2ie(&mut self) -> Cc2ieW<Lptim3DierInputSpec> {
        Cc2ieW::new(self, 9)
    }
    #[doc = "Bit 10 - Capture/compare 3 interrupt enable Note: If LPTIM does not implement at least 3 channels this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cc3ie(&mut self) -> Cc3ieW<Lptim3DierInputSpec> {
        Cc3ieW::new(self, 10)
    }
    #[doc = "Bit 11 - Capture/compare 4 interrupt enable Note: If LPTIM does not implement at least 4 channels this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cc4ie(&mut self) -> Cc4ieW<Lptim3DierInputSpec> {
        Cc4ieW::new(self, 11)
    }
    #[doc = "Bit 12 - Capture/compare 1 over-capture interrupt enable Note: If LPTIM does not implement at least 1 channel this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cc1oie(&mut self) -> Cc1oieW<Lptim3DierInputSpec> {
        Cc1oieW::new(self, 12)
    }
    #[doc = "Bit 13 - Capture/compare 2 over-capture interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cc2oie(&mut self) -> Cc2oieW<Lptim3DierInputSpec> {
        Cc2oieW::new(self, 13)
    }
    #[doc = "Bit 14 - Capture/compare 3 over-capture interrupt enable Note: If LPTIM does not implement at least 3 channels this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cc3oie(&mut self) -> Cc3oieW<Lptim3DierInputSpec> {
        Cc3oieW::new(self, 14)
    }
    #[doc = "Bit 15 - Capture/compare 4 over-capture interrupt enable Note: If LPTIM does not implement at least 4 channels this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cc4oie(&mut self) -> Cc4oieW<Lptim3DierInputSpec> {
        Cc4oieW::new(self, 15)
    }
    #[doc = "Bit 16 - Capture/compare 1 DMA request enable Note: If LPTIM does not implement at least 1 channel this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cc1de(&mut self) -> Cc1deW<Lptim3DierInputSpec> {
        Cc1deW::new(self, 16)
    }
    #[doc = "Bit 23 - Update event DMA request enable Note: If LPTIM does not implement at least 1 channel this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn uede(&mut self) -> UedeW<Lptim3DierInputSpec> {
        UedeW::new(self, 23)
    }
    #[doc = "Bit 25 - Capture/compare 2 DMA request enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cc2de(&mut self) -> Cc2deW<Lptim3DierInputSpec> {
        Cc2deW::new(self, 25)
    }
    #[doc = "Bit 26 - Capture/compare 3 DMA request enable Note: If LPTIM does not implement at least 3 channels this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cc3de(&mut self) -> Cc3deW<Lptim3DierInputSpec> {
        Cc3deW::new(self, 26)
    }
    #[doc = "Bit 27 - Capture/compare 4 DMA request enable Note: If LPTIM does not implement at least 4 channels this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cc4de(&mut self) -> Cc4deW<Lptim3DierInputSpec> {
        Cc4deW::new(self, 27)
    }
}
#[doc = "LPTIM3 interrupt enable register \\[alternate\\]\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lptim3_dier_input::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lptim3_dier_input::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lptim3DierInputSpec;
impl crate::RegisterSpec for Lptim3DierInputSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lptim3_dier_input::R`](R) reader structure"]
impl crate::Readable for Lptim3DierInputSpec {}
#[doc = "`write(|w| ..)` method takes [`lptim3_dier_input::W`](W) writer structure"]
impl crate::Writable for Lptim3DierInputSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPTIM3_DIER_INPUT to value 0"]
impl crate::Resettable for Lptim3DierInputSpec {
