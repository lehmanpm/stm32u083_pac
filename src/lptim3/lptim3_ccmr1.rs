#[doc = "Register `LPTIM3_CCMR1` reader"]
pub type R = crate::R<Lptim3Ccmr1Spec>;
#[doc = "Register `LPTIM3_CCMR1` writer"]
pub type W = crate::W<Lptim3Ccmr1Spec>;
...
#[doc = "Capture/compare 1 output enable. This bit determines if a capture of the counter value can actually be done into the input capture/compare register 1 (LPTIM3_CCR1) or not.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Cc1e {
...
#[doc = "Field `CC1E` reader - Capture/compare 1 output enable. This bit determines if a capture of the counter value can actually be done into the input capture/compare register 1 (LPTIM3_CCR1) or not."]
...
#[doc = "Field `CC1E` writer - Capture/compare 1 output enable. This bit determines if a capture of the counter value can actually be done into the input capture/compare register 1 (LPTIM3_CCR1) or not."]
...
#[repr(u8)]
pub enum Cc1p {
    #[doc = "0: If CC1 is an Output, OC1 active high, the LPTIM output reflects the compare results between LPTIM3_ARR and LPTIM3_CCRx registers. If CC1 is an Input, rising edge, circuit is sensitive to IC1 rising edge."]
    B0x0Cc1 = 0,
    #[doc = "1: If CC1 is an Output, OC1 active low, the LPTIM output reflects the inverse of the compare results between LPTIM3_ARR and LPTIM3_CCRx registers. If CC1 is an Input, falling edge, circuit is sensitive to IC1 falling edge."]
    B0x1Cc1 = 1,
...
impl Cc1pR {
    ...
    #[doc = "If CC1 is an Output, OC1 active high, the LPTIM output reflects the compare results between LPTIM3_ARR and LPTIM3_CCRx registers. If CC1 is an Input, rising edge, circuit is sensitive to IC1 rising edge."]
    #[inline(always)]
    pub fn is_b_0x0_cc1(&self) -> bool {
        *self == Cc1p::B0x0Cc1
    }
    #[doc = "If CC1 is an Output, OC1 active low, the LPTIM output reflects the inverse of the compare results between LPTIM3_ARR and LPTIM3_CCRx registers. If CC1 is an Input, falling edge, circuit is sensitive to IC1 falling edge."]
    #[inline(always)]
    pub fn is_b_0x1_cc1(&self) -> bool {
        *self == Cc1p::B0x1Cc1
    }
...
#[doc = "Capture/compare 2 output enable. This bit determines if a capture of the counter value can actually be done into the input capture/compare register 2 (LPTIM3_CCR2) or not.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Cc2e {
...
#[doc = "Field `CC2E` reader - Capture/compare 2 output enable. This bit determines if a capture of the counter value can actually be done into the input capture/compare register 2 (LPTIM3_CCR2) or not."]
...
#[doc = "Field `CC2E` writer - Capture/compare 2 output enable. This bit determines if a capture of the counter value can actually be done into the input capture/compare register 2 (LPTIM3_CCR2) or not."]
...
impl R {
    ...
    #[doc = "Bit 1 - Capture/compare 1 output enable. This bit determines if a capture of the counter value can actually be done into the input capture/compare register 1 (LPTIM3_CCR1) or not."]
    #[inline(always)]
    ...
    #[doc = "Bit 17 - Capture/compare 2 output enable. This bit determines if a capture of the counter value can actually be done into the input capture/compare register 2 (LPTIM3_CCR2) or not."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc1sel(&mut self) -> Cc1selW<Lptim3Ccmr1Spec> {
        Cc1selW::new(self, 0)
    }
    #[doc = "Bit 1 - Capture/compare 1 output enable. This bit determines if a capture of the counter value can actually be done into the input capture/compare register 1 (LPTIM3_CCR1) or not."]
    #[inline(always)]
    #[must_use]
    pub fn cc1e(&mut self) -> Cc1eW<Lptim3Ccmr1Spec> {
        Cc1eW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Capture/compare 1 output polarity. Only bit2 is used to set polarity when output mode is enabled, bit3 is don't care. This field is used to select the IC1 polarity for capture operations."]
    #[inline(always)]
    #[must_use]
    pub fn cc1p(&mut self) -> Cc1pW<Lptim3Ccmr1Spec> {
        Cc1pW::new(self, 2)
    }
    #[doc = "Bits 8:9 - Input capture 1 prescaler This bitfield defines the ratio of the prescaler acting on the CC1 input (IC1)."]
    #[inline(always)]
    #[must_use]
    pub fn ic1psc(&mut self) -> Ic1pscW<Lptim3Ccmr1Spec> {
        Ic1pscW::new(self, 8)
    }
    #[doc = "Bits 12:13 - Input capture 1 filter This bitfield defines the number of consecutive equal samples that are detected when a level change occurs on an external input capture signal before it is considered as a valid level transition. An internal clock source must be present to use this feature."]
    #[inline(always)]
    #[must_use]
    pub fn ic1f(&mut self) -> Ic1fW<Lptim3Ccmr1Spec> {
        Ic1fW::new(self, 12)
    }
    #[doc = "Bit 16 - Capture/compare 2 selection This bitfield defines the direction of the channel, input (capture) or output mode."]
    #[inline(always)]
    #[must_use]
    pub fn cc2sel(&mut self) -> Cc2selW<Lptim3Ccmr1Spec> {
        Cc2selW::new(self, 16)
    }
    #[doc = "Bit 17 - Capture/compare 2 output enable. This bit determines if a capture of the counter value can actually be done into the input capture/compare register 2 (LPTIM3_CCR2) or not."]
    #[inline(always)]
    #[must_use]
    pub fn cc2e(&mut self) -> Cc2eW<Lptim3Ccmr1Spec> {
        Cc2eW::new(self, 17)
    }
    #[doc = "Bits 18:19 - Capture/compare 2 output polarity. Only bit2 is used to set polarity when output mode is enabled, bit3 is don't care. This field is used to select the IC2 polarity for capture operations."]
    #[inline(always)]
    #[must_use]
    pub fn cc2p(&mut self) -> Cc2pW<Lptim3Ccmr1Spec> {
        Cc2pW::new(self, 18)
    }
    #[doc = "Bits 24:25 - Input capture 2 prescaler This bitfield defines the ratio of the prescaler acting on the CC2 input (IC2)."]
    #[inline(always)]
    #[must_use]
    pub fn ic2psc(&mut self) -> Ic2pscW<Lptim3Ccmr1Spec> {
        Ic2pscW::new(self, 24)
    }
    #[doc = "Bits 28:29 - Input capture 2 filter This bitfield defines the number of consecutive equal samples that are detected when a level change occurs on an external input capture signal before it is considered as a valid level transition. An internal clock source must be present to use this feature."]
    #[inline(always)]
    #[must_use]
    pub fn ic2f(&mut self) -> Ic2fW<Lptim3Ccmr1Spec> {
        Ic2fW::new(self, 28)
    }
}
#[doc = "LPTIM capture/compare mode register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lptim3_ccmr1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lptim3_ccmr1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lptim3Ccmr1Spec;
impl crate::RegisterSpec for Lptim3Ccmr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lptim3_ccmr1::R`](R) reader structure"]
impl crate::Readable for Lptim3Ccmr1Spec {}
#[doc = "`write(|w| ..)` method takes [`lptim3_ccmr1::W`](W) writer structure"]
impl crate::Writable for Lptim3Ccmr1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPTIM3_CCMR1 to value 0"]
impl crate::Resettable for Lptim3Ccmr1Spec {
