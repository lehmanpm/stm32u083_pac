#[doc = "Register `LPTIM3_ICR_OUTPUT` writer"]
pub type W = crate::W<Lptim3IcrOutputSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp1okcf(&mut self) -> Cmp1okcfW<Lptim3IcrOutputSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn arrokcf(&mut self) -> ArrokcfW<Lptim3IcrOutputSpec> {
        ArrokcfW::new(self, 4)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn upcf(&mut self) -> UpcfW<Lptim3IcrOutputSpec> {
        UpcfW::new(self, 5)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc2cf(&mut self) -> Cc2cfW<Lptim3IcrOutputSpec> {
        Cc2cfW::new(self, 9)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc3cf(&mut self) -> Cc3cfW<Lptim3IcrOutputSpec> {
        Cc3cfW::new(self, 10)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc4cf(&mut self) -> Cc4cfW<Lptim3IcrOutputSpec> {
        Cc4cfW::new(self, 11)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp2okcf(&mut self) -> Cmp2okcfW<Lptim3IcrOutputSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp3okcf(&mut self) -> Cmp3okcfW<Lptim3IcrOutputSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp4okcf(&mut self) -> Cmp4okcfW<Lptim3IcrOutputSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dierokcf(&mut self) -> DierokcfW<Lptim3IcrOutputSpec> {
        DierokcfW::new(self, 24)
    }
}
#[doc = "LPTIM3 interrupt clear register \\[alternate\\]\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lptim3_icr_output::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lptim3IcrOutputSpec;
impl crate::RegisterSpec for Lptim3IcrOutputSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`lptim3_icr_output::W`](W) writer structure"]
impl crate::Writable for Lptim3IcrOutputSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPTIM3_ICR_OUTPUT to value 0"]
impl crate::Resettable for Lptim3IcrOutputSpec {
