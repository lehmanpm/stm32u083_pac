...
pub enum Msk1 {
    ...
    B0x0 = 0,
    #[doc = "1: Seconds dont care in alarm B comparison"]
    B0x1 = 1,
}
...
impl Msk1R {
    ...
    #[doc = "Seconds dont care in alarm B comparison"]
    #[inline(always)]
...
pub enum Msk2 {
    ...
    B0x0 = 0,
    #[doc = "1: Minutes dont care in alarm B comparison"]
    B0x1 = 1,
}
...
impl Msk2R {
    ...
    #[doc = "Minutes dont care in alarm B comparison"]
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == Msk2::B0x1
    }
...
pub enum Msk3 {
    ...
    B0x0 = 0,
    #[doc = "1: Hours dont care in alarm B comparison"]
    B0x1 = 1,
}
...
impl Msk3R {
    ...
    #[doc = "Hours dont care in alarm B comparison"]
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == Msk3::B0x1
    }
...
pub enum Msk4 {
    ...
    B0x0 = 0,
    #[doc = "1: Date and day dont care in alarm B comparison"]
    B0x1 = 1,
}
...
impl Msk4R {
    ...
    #[doc = "Date and day dont care in alarm B comparison"]
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == Msk4::B0x1
    }
