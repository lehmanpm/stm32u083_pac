...
pub type R = crate::R<TampBkp7rSpec>;
#[doc = "Register `TAMP_BKP7R` writer"]
pub type W = crate::W<TampBkp7rSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bkp(&mut self) -> BkpW<TampBkp7rSpec> {
        BkpW::new(self, 0)
    }
}
...
pub struct TampBkp7rSpec;
impl crate::RegisterSpec for TampBkp7rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tamp_bkp7r::R`](R) reader structure"]
impl crate::Readable for TampBkp7rSpec {}
#[doc = "`write(|w| ..)` method takes [`tamp_bkp7r::W`](W) writer structure"]
impl crate::Writable for TampBkp7rSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TAMP_BKP7R to value 0"]
impl crate::Resettable for TampBkp7rSpec {
