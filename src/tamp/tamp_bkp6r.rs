...
pub type R = crate::R<TampBkp6rSpec>;
#[doc = "Register `TAMP_BKP6R` writer"]
pub type W = crate::W<TampBkp6rSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bkp(&mut self) -> BkpW<TampBkp6rSpec> {
        BkpW::new(self, 0)
    }
}
...
pub struct TampBkp6rSpec;
impl crate::RegisterSpec for TampBkp6rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tamp_bkp6r::R`](R) reader structure"]
impl crate::Readable for TampBkp6rSpec {}
#[doc = "`write(|w| ..)` method takes [`tamp_bkp6r::W`](W) writer structure"]
impl crate::Writable for TampBkp6rSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TAMP_BKP6R to value 0"]
impl crate::Resettable for TampBkp6rSpec {
