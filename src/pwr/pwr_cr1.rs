...
#[doc = "Field `LPMS` reader - Low-power mode selection These bits select the low-power mode entered when CPU enters the deepsleep mode. 1xx: Shutdown mode Note: If LPR bit is set, Stop 2 mode cannot be selected and Stop 1 mode shall be entered instead of Stop 2. Note: In Standby mode, SRAM2 can be preserved or not, depending on RRS bit configuration in PWR_CR3."]
...
#[doc = "Field `LPMS` writer - Low-power mode selection These bits select the low-power mode entered when CPU enters the deepsleep mode. 1xx: Shutdown mode Note: If LPR bit is set, Stop 2 mode cannot be selected and Stop 1 mode shall be entered instead of Stop 2. Note: In Standby mode, SRAM2 can be preserved or not, depending on RRS bit configuration in PWR_CR3."]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum FpdStop {
    #[doc = "0: Flash memory idle"]
    B0x0 = 0,
    #[doc = "1: Flash memory powered down"]
    B0x1 = 1,
}
impl From<FpdStop> for bool {
    #[inline(always)]
    fn from(variant: FpdStop) -> Self {
        variant as u8 != 0
    }
}
...
pub type FpdStopR = crate::BitReader<FpdStop>;
impl FpdStopR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> FpdStop {
        match self.bits {
            false => FpdStop::B0x0,
            true => FpdStop::B0x1,
        }
    }
    #[doc = "Flash memory idle"]
    #[inline(always)]
    pub fn is_b_0x0(&self) -> bool {
        *self == FpdStop::B0x0
    }
    #[doc = "Flash memory powered down"]
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == FpdStop::B0x1
    }
...
pub type FpdStopW<'a, REG> = crate::BitWriter<'a, REG, FpdStop>;
impl<'a, REG> FpdStopW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Flash memory idle"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(FpdStop::B0x0)
    }
    #[doc = "Flash memory powered down"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(FpdStop::B0x1)
    }
}
...
impl From<FpdLprun> for bool {
    #[inline(always)]
    fn from(variant: FpdLprun) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `FPD_LPRUN` reader - Flash memory powered down during Low-power run mode. This bit determines whether the flash memory is put in power-down mode or remains in idle mode when the device enters Low-power sleep mode."]
pub type FpdLprunR = crate::BitReader<FpdLprun>;
impl FpdLprunR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> FpdLprun {
        match self.bits {
            false => FpdLprun::B0x0,
            true => FpdLprun::B0x1,
        }
...
#[doc = "Field `FPD_LPRUN` writer - Flash memory powered down during Low-power run mode. This bit determines whether the flash memory is put in power-down mode or remains in idle mode when the device enters Low-power sleep mode."]
pub type FpdLprunW<'a, REG> = crate::BitWriter<'a, REG, FpdLprun>;
impl<'a, REG> FpdLprunW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Flash memory idle"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(FpdLprun::B0x0)
    }
    #[doc = "Flash memory powered down"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(FpdLprun::B0x1)
    }
}
...
impl From<FpdLpslp> for bool {
    #[inline(always)]
    fn from(variant: FpdLpslp) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `FPD_LPSLP` reader - Flash memory powered down during Low-power sleep mode. This bit determines whether the flash memory is put in power-down mode or remains in idle mode when the device enters Low-power sleep mode."]
pub type FpdLpslpR = crate::BitReader<FpdLpslp>;
impl FpdLpslpR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> FpdLpslp {
        match self.bits {
            false => FpdLpslp::B0x0,
            true => FpdLpslp::B0x1,
        }
...
#[doc = "Field `FPD_LPSLP` writer - Flash memory powered down during Low-power sleep mode. This bit determines whether the flash memory is put in power-down mode or remains in idle mode when the device enters Low-power sleep mode."]
pub type FpdLpslpW<'a, REG> = crate::BitWriter<'a, REG, FpdLpslp>;
impl<'a, REG> FpdLpslpW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Flash memory idle"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(FpdLpslp::B0x0)
    }
    #[doc = "Flash memory powered down"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(FpdLpslp::B0x1)
    }
}
...
#[doc = "Field `LPR` reader - Low-power run When this bit is set, the regulator is switched from main mode (MR) to low-power mode (LPR). Note: Stop 2 mode cannot be entered when LPR bit is set. Stop 1 is entered instead."]
pub type LprR = crate::BitReader;
#[doc = "Field `LPR` writer - Low-power run When this bit is set, the regulator is switched from main mode (MR) to low-power mode (LPR). Note: Stop 2 mode cannot be entered when LPR bit is set. Stop 1 is entered instead."]
pub type LprW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:2 - Low-power mode selection These bits select the low-power mode entered when CPU enters the deepsleep mode. 1xx: Shutdown mode Note: If LPR bit is set, Stop 2 mode cannot be selected and Stop 1 mode shall be entered instead of Stop 2. Note: In Standby mode, SRAM2 can be preserved or not, depending on RRS bit configuration in PWR_CR3."]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Flash memory powered down during Low-power run mode. This bit determines whether the flash memory is put in power-down mode or remains in idle mode when the device enters Low-power sleep mode."]
    #[inline(always)]
    pub fn fpd_lprun(&self) -> FpdLprunR {
        FpdLprunR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Flash memory powered down during Low-power sleep mode. This bit determines whether the flash memory is put in power-down mode or remains in idle mode when the device enters Low-power sleep mode."]
    #[inline(always)]
    ...
    #[doc = "Bit 14 - Low-power run When this bit is set, the regulator is switched from main mode (MR) to low-power mode (LPR). Note: Stop 2 mode cannot be entered when LPR bit is set. Stop 1 is entered instead."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fpd_lprun(&mut self) -> FpdLprunW<PwrCr1Spec> {
        FpdLprunW::new(self, 4)
    }
    #[doc = "Bit 5 - Flash memory powered down during Low-power sleep mode. This bit determines whether the flash memory is put in power-down mode or remains in idle mode when the device enters Low-power sleep mode."]
    #[inline(always)]
    #[must_use]
    pub fn fpd_lpslp(&mut self) -> FpdLpslpW<PwrCr1Spec> {
...
#[doc = "`reset()` method sets PWR_CR1 to value 0x0208"]
