...
#[doc = "Field `WP1` reader - Wake-up pin WKUP1 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP1"]
...
#[doc = "Field `WP1` writer - Wake-up pin WKUP1 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP1"]
...
#[doc = "Field `WP2` reader - Wake-up pin WKUP2 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP2"]
...
#[doc = "Field `WP2` writer - Wake-up pin WKUP2 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP2"]
...
#[doc = "Field `WP3` reader - Wake-up pin WKUP3 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP3"]
...
#[doc = "Field `WP3` writer - Wake-up pin WKUP3 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP3"]
...
#[doc = "Field `WP4` reader - Wake-up pin WKUP4 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP4"]
...
#[doc = "Field `WP4` writer - Wake-up pin WKUP4 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP4"]
...
#[doc = "Field `WP5` reader - Wake-up pin WKUP5 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP5"]
...
#[doc = "Field `WP5` writer - Wake-up pin WKUP5 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP5"]
...
#[doc = "Field `WP7` reader - Wake-up pin WKUP7 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP7"]
...
#[doc = "Field `WP7` writer - Wake-up pin WKUP7 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP7"]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(Wp7::B0x0)
    }
    #[doc = "Detection on low level (falling edge)"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(Wp7::B0x1)
    }
}
...
impl R {
    #[doc = "Bit 0 - Wake-up pin WKUP1 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP1"]
    #[inline(always)]
    pub fn wp1(&self) -> Wp1R {
        Wp1R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Wake-up pin WKUP2 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP2"]
    #[inline(always)]
    pub fn wp2(&self) -> Wp2R {
        Wp2R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Wake-up pin WKUP3 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP3"]
    #[inline(always)]
    pub fn wp3(&self) -> Wp3R {
        Wp3R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Wake-up pin WKUP4 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP4"]
    #[inline(always)]
    pub fn wp4(&self) -> Wp4R {
        Wp4R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Wake-up pin WKUP5 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP5"]
    #[inline(always)]
    pub fn wp5(&self) -> Wp5R {
        Wp5R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 6 - Wake-up pin WKUP7 polarity This bit defines the polarity used for an event detection on external wake-up pin, WKUP7"]
    #[inline(always)]
    pub fn wp7(&self) -> Wp7R {
        Wp7R::new(((self.bits >> 6) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wp7(&mut self) -> Wp7W<PwrCr4Spec> {
        Wp7W::new(self, 6)
    }
    #[doc = "Bit 8 - V&lt;sub>BAT&lt;/sub> battery charging enable"]
    #[inline(always)]
