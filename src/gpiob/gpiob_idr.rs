...
pub type R = crate::R<GpiobIdrSpec>;
...
pub struct GpiobIdrSpec;
impl crate::RegisterSpec for GpiobIdrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiob_idr::R`](R) reader structure"]
impl crate::Readable for GpiobIdrSpec {}
#[doc = "`reset()` method sets GPIOB_IDR to value 0"]
impl crate::Resettable for GpiobIdrSpec {
