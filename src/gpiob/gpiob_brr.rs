...
pub type W = crate::W<GpiobBrrSpec>;
...
pub struct GpiobBrrSpec;
impl crate::RegisterSpec for GpiobBrrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`gpiob_brr::W`](W) writer structure"]
impl crate::Writable for GpiobBrrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIOB_BRR to value 0"]
impl crate::Resettable for GpiobBrrSpec {
