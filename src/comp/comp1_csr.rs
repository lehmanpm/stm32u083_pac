...
#[doc = "Comparator 1 enable bit This bit is controlled by software (if not locked). It enables the comparator 1:\n\nValue on reset: 0"]
...
#[doc = "Field `INMSEL` reader - Comparator 1 signal selector for inverting input INM This bitfield is controlled by software (if not locked). It selects the signal for the inverting input COMP_INM of the comparator 1: Refer to Table176: COMP1 inverting input assignment."]
pub type InmselR = crate::FieldReader;
#[doc = "Field `INMSEL` writer - Comparator 1 signal selector for inverting input INM This bitfield is controlled by software (if not locked). It selects the signal for the inverting input COMP_INM of the comparator 1: Refer to Table176: COMP1 inverting input assignment."]
pub type InmselW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `INPSEL` reader - Comparator 1 signal selector for noninverting input This bitfield is controlled by software (if not locked). It selects the signal for the noninverting input COMP_INP of the comparator 1 (also see the WINMODE bit): Refer to Table175: COMP1 noninverting input assignment."]
pub type InpselR = crate::FieldReader;
#[doc = "Field `INPSEL` writer - Comparator 1 signal selector for noninverting input This bitfield is controlled by software (if not locked). It selects the signal for the noninverting input COMP_INP of the comparator 1 (also see the WINMODE bit): Refer to Table175: COMP1 noninverting input assignment."]
pub type InpselW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Comparator 1 noninverting input selector for window mode This bit is controlled by software (if not locked). It selects the signal for COMP_INP input of the comparator 1:\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Winmode {
    #[doc = "0: Signal selected with INPSEL\\[2:0\\]
bitfield of this register"]
    B0x0 = 0,
    #[doc = "1: COMP_INP signal of the comparator 2 (required for window mode, see Figure164)"]
    B0x1 = 1,
}
...
#[doc = "Field `WINMODE` reader - Comparator 1 noninverting input selector for window mode This bit is controlled by software (if not locked). It selects the signal for COMP_INP input of the comparator 1:"]
...
bitfield of this register"]
    ...
    #[doc = "COMP_INP signal of the comparator 2 (required for window mode, see Figure164)"]
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == Winmode::B0x1
    }
}
#[doc = "Field `WINMODE` writer - Comparator 1 noninverting input selector for window mode This bit is controlled by software (if not locked). It selects the signal for COMP_INP input of the comparator 1:"]
...
#[doc = "Comparator 1 output selector This bit is controlled by software (if not locked). It selects the comparator 1 output:\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Winout {
    #[doc = "0: COMP_VALUE"]
    B0x0 = 0,
...
#[doc = "Comparator 1 polarity selector This bit is controlled by software (if not locked). It selects the comparator 1 output polarity:\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Polarity {
    #[doc = "0: Non-inverted"]
    B0x0 = 0,
...
#[doc = "Comparator 1 hysteresis selector This bitfield is controlled by software (if not locked). It selects the hysteresis of the comparator 1:\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Hyst {
    #[doc = "0: No hysteresis"]
...
#[doc = "Comparator 1 power mode selector This bitfield is controlled by software (if not locked). It selects the power consumption and as a consequence the speed of the comparator 1:\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Pwrmode {
...
#[doc = "Field `PWRMODE` reader - Comparator 1 power mode selector This bitfield is controlled by software (if not locked). It selects the power consumption and as a consequence the speed of the comparator 1:"]
...
#[doc = "Field `PWRMODE` writer - Comparator 1 power mode selector This bitfield is controlled by software (if not locked). It selects the power consumption and as a consequence the speed of the comparator 1:"]
...
#[doc = "Comparator 1 blanking source selector This bitfield is controlled by software (if not locked). It selects the blanking source: Others: Reserved, must not be used\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Blanksel {
    #[doc = "0: No blanking"]
...
#[doc = "Field `BLANKSEL` reader - Comparator 1 blanking source selector This bitfield is controlled by software (if not locked). It selects the blanking source: Others: Reserved, must not be used"]
...
#[doc = "Field `BLANKSEL` writer - Comparator 1 blanking source selector This bitfield is controlled by software (if not locked). It selects the blanking source: Others: Reserved, must not be used"]
...
#[doc = "Field `VALUE` reader - Comparator 1 output status This bit is read-only. It reflects the level of the comparator 1 output after the polarity selector and blanking, as indicated in Figure163."]
...
impl R {
    ...
    #[doc = "Bits 4:7 - Comparator 1 signal selector for inverting input INM This bitfield is controlled by software (if not locked). It selects the signal for the inverting input COMP_INM of the comparator 1: Refer to Table176: COMP1 inverting input assignment."]
    #[inline(always)]
    pub fn inmsel(&self) -> InmselR {
        InmselR::new(((self.bits >> 4) & 0x0f) as u8)
    }
    #[doc = "Bits 8:10 - Comparator 1 signal selector for noninverting input This bitfield is controlled by software (if not locked). It selects the signal for the noninverting input COMP_INP of the comparator 1 (also see the WINMODE bit): Refer to Table175: COMP1 noninverting input assignment."]
    #[inline(always)]
    pub fn inpsel(&self) -> InpselR {
        InpselR::new(((self.bits >> 8) & 7) as u8)
    }
    #[doc = "Bit 11 - Comparator 1 noninverting input selector for window mode This bit is controlled by software (if not locked). It selects the signal for COMP_INP input of the comparator 1:"]
    #[inline(always)]
    ...
    #[doc = "Bits 18:19 - Comparator 1 power mode selector This bitfield is controlled by software (if not locked). It selects the power consumption and as a consequence the speed of the comparator 1:"]
    #[inline(always)]
    pub fn pwrmode(&self) -> PwrmodeR {
        PwrmodeR::new(((self.bits >> 18) & 3) as u8)
    }
    #[doc = "Bits 20:24 - Comparator 1 blanking source selector This bitfield is controlled by software (if not locked). It selects the blanking source: Others: Reserved, must not be used"]
    #[inline(always)]
    pub fn blanksel(&self) -> BlankselR {
        BlankselR::new(((self.bits >> 20) & 0x1f) as u8)
    }
    #[doc = "Bit 30 - Comparator 1 output status This bit is read-only. It reflects the level of the comparator 1 output after the polarity selector and blanking, as indicated in Figure163."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn inmsel(&mut self) -> InmselW<Comp1CsrSpec> {
        InmselW::new(self, 4)
    }
    #[doc = "Bits 8:10 - Comparator 1 signal selector for noninverting input This bitfield is controlled by software (if not locked). It selects the signal for the noninverting input COMP_INP of the comparator 1 (also see the WINMODE bit): Refer to Table175: COMP1 noninverting input assignment."]
    #[inline(always)]
    #[must_use]
    pub fn inpsel(&mut self) -> InpselW<Comp1CsrSpec> {
        InpselW::new(self, 8)
    }
    #[doc = "Bit 11 - Comparator 1 noninverting input selector for window mode This bit is controlled by software (if not locked). It selects the signal for COMP_INP input of the comparator 1:"]
    #[inline(always)]
    #[must_use]
    pub fn winmode(&mut self) -> WinmodeW<Comp1CsrSpec> {
        WinmodeW::new(self, 11)
    }
    #[doc = "Bit 14 - Comparator 1 output selector This bit is controlled by software (if not locked). It selects the comparator 1 output:"]
    #[inline(always)]
    #[must_use]
    pub fn winout(&mut self) -> WinoutW<Comp1CsrSpec> {
        WinoutW::new(self, 14)
    }
    #[doc = "Bit 15 - Comparator 1 polarity selector This bit is controlled by software (if not locked). It selects the comparator 1 output polarity:"]
    #[inline(always)]
    #[must_use]
    pub fn polarity(&mut self) -> PolarityW<Comp1CsrSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwrmode(&mut self) -> PwrmodeW<Comp1CsrSpec> {
        PwrmodeW::new(self, 18)
    }
    #[doc = "Bits 20:24 - Comparator 1 blanking source selector This bitfield is controlled by software (if not locked). It selects the blanking source: Others: Reserved, must not be used"]
    #[inline(always)]
    #[must_use]
    pub fn blanksel(&mut self) -> BlankselW<Comp1CsrSpec> {
