...
pub type W = crate::W<Tim6EgrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ug(&mut self) -> UgW<Tim6EgrSpec> {
        UgW::new(self, 0)
    }
}
...
pub struct Tim6EgrSpec;
impl crate::RegisterSpec for Tim6EgrSpec {
    type Ux = u16;
}
#[doc = "`write(|w| ..)` method takes [`tim6_egr::W`](W) writer structure"]
impl crate::Writable for Tim6EgrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets TIM6_EGR to value 0"]
impl crate::Resettable for Tim6EgrSpec {
