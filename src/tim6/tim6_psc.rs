...
pub type R = crate::R<Tim6PscSpec>;
#[doc = "Register `TIM6_PSC` writer"]
pub type W = crate::W<Tim6PscSpec>;
...
+ 1). PSC contains the value to be loaded into the active prescaler register at each update event. (including when the counter is cleared through UG bit of TIMx_EGR register or through trigger controller when configured in reset mode)."]
    #[inline(always)]
    #[must_use]
    pub fn psc(&mut self) -> PscW<Tim6PscSpec> {
        PscW::new(self, 0)
    }
}
...
pub struct Tim6PscSpec;
impl crate::RegisterSpec for Tim6PscSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`tim6_psc::R`](R) reader structure"]
impl crate::Readable for Tim6PscSpec {}
#[doc = "`write(|w| ..)` method takes [`tim6_psc::W`](W) writer structure"]
impl crate::Writable for Tim6PscSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets TIM6_PSC to value 0"]
impl crate::Resettable for Tim6PscSpec {
