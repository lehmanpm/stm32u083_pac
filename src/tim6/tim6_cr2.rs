...
pub type R = crate::R<Tim6Cr2Spec>;
#[doc = "Register `TIM6_CR2` writer"]
pub type W = crate::W<Tim6Cr2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mms(&mut self) -> MmsW<Tim6Cr2Spec> {
        MmsW::new(self, 4)
    }
}
...
pub struct Tim6Cr2Spec;
impl crate::RegisterSpec for Tim6Cr2Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`tim6_cr2::R`](R) reader structure"]
impl crate::Readable for Tim6Cr2Spec {}
#[doc = "`write(|w| ..)` method takes [`tim6_cr2::W`](W) writer structure"]
impl crate::Writable for Tim6Cr2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets TIM6_CR2 to value 0"]
impl crate::Resettable for Tim6Cr2Spec {
