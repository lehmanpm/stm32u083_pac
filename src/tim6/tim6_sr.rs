...
pub type R = crate::R<Tim6SrSpec>;
#[doc = "Register `TIM6_SR` writer"]
pub type W = crate::W<Tim6SrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uif(&mut self) -> UifW<Tim6SrSpec> {
        UifW::new(self, 0)
    }
}
