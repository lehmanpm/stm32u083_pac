...
pub type R = crate::R<Tim6Cr1Spec>;
#[doc = "Register `TIM6_CR1` writer"]
pub type W = crate::W<Tim6Cr1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cen(&mut self) -> CenW<Tim6Cr1Spec> {
        CenW::new(self, 0)
    }
    #[doc = "Bit 1 - Update disable This bit is set and cleared by software to enable/disable UEV event generation. Counter overflow/underflow Setting the UG bit Update generation through the slave mode controller Buffered registers are then loaded with their preload values."]
    #[inline(always)]
    #[must_use]
    pub fn udis(&mut self) -> UdisW<Tim6Cr1Spec> {
        UdisW::new(self, 1)
    }
    #[doc = "Bit 2 - Update request source This bit is set and cleared by software to select the UEV event sources. Counter overflow/underflow Setting the UG bit Update generation through the slave mode controller"]
    #[inline(always)]
    #[must_use]
    pub fn urs(&mut self) -> UrsW<Tim6Cr1Spec> {
        UrsW::new(self, 2)
    }
    #[doc = "Bit 3 - One-pulse mode"]
    #[inline(always)]
    #[must_use]
    pub fn opm(&mut self) -> OpmW<Tim6Cr1Spec> {
        OpmW::new(self, 3)
    }
    #[doc = "Bit 7 - Auto-reload preload enable"]
    #[inline(always)]
    #[must_use]
    pub fn arpe(&mut self) -> ArpeW<Tim6Cr1Spec> {
        ArpeW::new(self, 7)
    }
    #[doc = "Bit 11 - UIF status bit remapping"]
    #[inline(always)]
    #[must_use]
    pub fn uifremap(&mut self) -> UifremapW<Tim6Cr1Spec> {
...
pub struct Tim6Cr1Spec;
impl crate::RegisterSpec for Tim6Cr1Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`tim6_cr1::R`](R) reader structure"]
impl crate::Readable for Tim6Cr1Spec {}
#[doc = "`write(|w| ..)` method takes [`tim6_cr1::W`](W) writer structure"]
impl crate::Writable for Tim6Cr1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets TIM6_CR1 to value 0"]
impl crate::Resettable for Tim6Cr1Spec {
