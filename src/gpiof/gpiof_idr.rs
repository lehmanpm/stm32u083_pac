...
pub type R = crate::R<GpiofIdrSpec>;
...
pub struct GpiofIdrSpec;
impl crate::RegisterSpec for GpiofIdrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiof_idr::R`](R) reader structure"]
impl crate::Readable for GpiofIdrSpec {}
#[doc = "`reset()` method sets GPIOF_IDR to value 0"]
impl crate::Resettable for GpiofIdrSpec {
