...
pub type W = crate::W<GpiofBrrSpec>;
...
pub struct GpiofBrrSpec;
impl crate::RegisterSpec for GpiofBrrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`gpiof_brr::W`](W) writer structure"]
impl crate::Writable for GpiofBrrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIOF_BRR to value 0"]
impl crate::Resettable for GpiofBrrSpec {
