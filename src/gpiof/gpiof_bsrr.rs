...
pub type W = crate::W<GpiofBsrrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn br0(&mut self) -> Br0W<GpiofBsrrSpec> {
        Br0W::new(self, 16)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br1(&mut self) -> Br1W<GpiofBsrrSpec> {
        Br1W::new(self, 17)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br2(&mut self) -> Br2W<GpiofBsrrSpec> {
        Br2W::new(self, 18)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br3(&mut self) -> Br3W<GpiofBsrrSpec> {
        Br3W::new(self, 19)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br4(&mut self) -> Br4W<GpiofBsrrSpec> {
        Br4W::new(self, 20)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br5(&mut self) -> Br5W<GpiofBsrrSpec> {
        Br5W::new(self, 21)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br6(&mut self) -> Br6W<GpiofBsrrSpec> {
        Br6W::new(self, 22)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br7(&mut self) -> Br7W<GpiofBsrrSpec> {
        Br7W::new(self, 23)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br8(&mut self) -> Br8W<GpiofBsrrSpec> {
        Br8W::new(self, 24)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br9(&mut self) -> Br9W<GpiofBsrrSpec> {
        Br9W::new(self, 25)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br10(&mut self) -> Br10W<GpiofBsrrSpec> {
        Br10W::new(self, 26)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br11(&mut self) -> Br11W<GpiofBsrrSpec> {
        Br11W::new(self, 27)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br12(&mut self) -> Br12W<GpiofBsrrSpec> {
        Br12W::new(self, 28)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br13(&mut self) -> Br13W<GpiofBsrrSpec> {
        Br13W::new(self, 29)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br14(&mut self) -> Br14W<GpiofBsrrSpec> {
        Br14W::new(self, 30)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br15(&mut self) -> Br15W<GpiofBsrrSpec> {
        Br15W::new(self, 31)
    }
}
...
pub struct GpiofBsrrSpec;
impl crate::RegisterSpec for GpiofBsrrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`gpiof_bsrr::W`](W) writer structure"]
impl crate::Writable for GpiofBsrrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIOF_BSRR to value 0"]
impl crate::Resettable for GpiofBsrrSpec {
