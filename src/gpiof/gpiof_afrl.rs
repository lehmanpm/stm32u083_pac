...
pub type R = crate::R<GpiofAfrlSpec>;
#[doc = "Register `GPIOF_AFRL` writer"]
pub type W = crate::W<GpiofAfrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn afsel0(&mut self) -> Afsel0W<GpiofAfrlSpec> {
        Afsel0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel1(&mut self) -> Afsel1W<GpiofAfrlSpec> {
        Afsel1W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel2(&mut self) -> Afsel2W<GpiofAfrlSpec> {
        Afsel2W::new(self, 8)
    }
    #[doc = "Bits 12:15 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel3(&mut self) -> Afsel3W<GpiofAfrlSpec> {
        Afsel3W::new(self, 12)
    }
    #[doc = "Bits 16:19 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel4(&mut self) -> Afsel4W<GpiofAfrlSpec> {
        Afsel4W::new(self, 16)
    }
    #[doc = "Bits 20:23 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel5(&mut self) -> Afsel5W<GpiofAfrlSpec> {
        Afsel5W::new(self, 20)
    }
    #[doc = "Bits 24:27 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel6(&mut self) -> Afsel6W<GpiofAfrlSpec> {
        Afsel6W::new(self, 24)
    }
    #[doc = "Bits 28:31 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel7(&mut self) -> Afsel7W<GpiofAfrlSpec> {
        Afsel7W::new(self, 28)
    }
}
...
pub struct GpiofAfrlSpec;
impl crate::RegisterSpec for GpiofAfrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiof_afrl::R`](R) reader structure"]
impl crate::Readable for GpiofAfrlSpec {}
#[doc = "`write(|w| ..)` method takes [`gpiof_afrl::W`](W) writer structure"]
impl crate::Writable for GpiofAfrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIOF_AFRL to value 0"]
impl crate::Resettable for GpiofAfrlSpec {
