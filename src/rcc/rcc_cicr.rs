...
#[doc = "Field `MSIRDYC` writer - MSI ready interrupt clear This bit is set by software to clear the MSIRDYF flag."]
pub type MsirdycW<'a, REG> = crate::BitWriter<'a, REG, Msirdyc>;
impl<'a, REG> MsirdycW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut crate::W<REG> {
        self.variant(Msirdyc::B0x0)
    }
    #[doc = "MSIRDYF cleared"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut crate::W<REG> {
        self.variant(Msirdyc::B0x1)
    }
}
...
impl W {
    ...
    #[doc = "Bit 2 - MSI ready interrupt clear This bit is set by software to clear the MSIRDYF flag."]
    #[inline(always)]
    #[must_use]
    pub fn msirdyc(&mut self) -> MsirdycW<RccCicrSpec> {
        MsirdycW::new(self, 2)
    }
