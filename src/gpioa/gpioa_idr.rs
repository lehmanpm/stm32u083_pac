...
pub type R = crate::R<GpioaIdrSpec>;
...
pub struct GpioaIdrSpec;
impl crate::RegisterSpec for GpioaIdrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_idr::R`](R) reader structure"]
impl crate::Readable for GpioaIdrSpec {}
#[doc = "`reset()` method sets GPIOA_IDR to value 0"]
impl crate::Resettable for GpioaIdrSpec {
