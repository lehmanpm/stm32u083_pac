...
pub type R = crate::R<GpioaOtyperSpec>;
#[doc = "Register `GPIOA_OTYPER` writer"]
pub type W = crate::W<GpioaOtyperSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ot0(&mut self) -> Ot0W<GpioaOtyperSpec> {
        Ot0W::new(self, 0)
    }
    #[doc = "Bit 1 - Port x configuration I/O pin y These bits are written by software to configure the I/O output type."]
    #[inline(always)]
    #[must_use]
    pub fn ot1(&mut self) -> Ot1W<GpioaOtyperSpec> {
        Ot1W::new(self, 1)
    }
    #[doc = "Bit 2 - Port x configuration I/O pin y These bits are written by software to configure the I/O output type."]
    #[inline(always)]
    #[must_use]
    pub fn ot2(&mut self) -> Ot2W<GpioaOtyperSpec> {
        Ot2W::new(self, 2)
    }
    #[doc = "Bit 3 - Port x configuration I/O pin y These bits are written by software to configure the I/O output type."]
    #[inline(always)]
    #[must_use]
    pub fn ot3(&mut self) -> Ot3W<GpioaOtyperSpec> {
        Ot3W::new(self, 3)
    }
    #[doc = "Bit 4 - Port x configuration I/O pin y These bits are written by software to configure the I/O output type."]
    #[inline(always)]
    #[must_use]
    pub fn ot4(&mut self) -> Ot4W<GpioaOtyperSpec> {
        Ot4W::new(self, 4)
    }
    #[doc = "Bit 5 - Port x configuration I/O pin y These bits are written by software to configure the I/O output type."]
    #[inline(always)]
    #[must_use]
    pub fn ot5(&mut self) -> Ot5W<GpioaOtyperSpec> {
        Ot5W::new(self, 5)
    }
    #[doc = "Bit 6 - Port x configuration I/O pin y These bits are written by software to configure the I/O output type."]
    #[inline(always)]
    #[must_use]
    pub fn ot6(&mut self) -> Ot6W<GpioaOtyperSpec> {
        Ot6W::new(self, 6)
    }
    #[doc = "Bit 7 - Port x configuration I/O pin y These bits are written by software to configure the I/O output type."]
    #[inline(always)]
    #[must_use]
    pub fn ot7(&mut self) -> Ot7W<GpioaOtyperSpec> {
        Ot7W::new(self, 7)
    }
    #[doc = "Bit 8 - Port x configuration I/O pin y These bits are written by software to configure the I/O output type."]
    #[inline(always)]
    #[must_use]
    pub fn ot8(&mut self) -> Ot8W<GpioaOtyperSpec> {
        Ot8W::new(self, 8)
    }
    #[doc = "Bit 9 - Port x configuration I/O pin y These bits are written by software to configure the I/O output type."]
    #[inline(always)]
    #[must_use]
    pub fn ot9(&mut self) -> Ot9W<GpioaOtyperSpec> {
        Ot9W::new(self, 9)
    }
    #[doc = "Bit 10 - Port x configuration I/O pin y These bits are written by software to configure the I/O output type."]
    #[inline(always)]
    #[must_use]
    pub fn ot10(&mut self) -> Ot10W<GpioaOtyperSpec> {
        Ot10W::new(self, 10)
    }
    #[doc = "Bit 11 - Port x configuration I/O pin y These bits are written by software to configure the I/O output type."]
    #[inline(always)]
    #[must_use]
    pub fn ot11(&mut self) -> Ot11W<GpioaOtyperSpec> {
        Ot11W::new(self, 11)
    }
    #[doc = "Bit 12 - Port x configuration I/O pin y These bits are written by software to configure the I/O output type."]
    #[inline(always)]
    #[must_use]
    pub fn ot12(&mut self) -> Ot12W<GpioaOtyperSpec> {
        Ot12W::new(self, 12)
    }
    #[doc = "Bit 13 - Port x configuration I/O pin y These bits are written by software to configure the I/O output type."]
    #[inline(always)]
    #[must_use]
    pub fn ot13(&mut self) -> Ot13W<GpioaOtyperSpec> {
        Ot13W::new(self, 13)
    }
    #[doc = "Bit 14 - Port x configuration I/O pin y These bits are written by software to configure the I/O output type."]
    #[inline(always)]
    #[must_use]
    pub fn ot14(&mut self) -> Ot14W<GpioaOtyperSpec> {
        Ot14W::new(self, 14)
    }
    #[doc = "Bit 15 - Port x configuration I/O pin y These bits are written by software to configure the I/O output type."]
    #[inline(always)]
    #[must_use]
    pub fn ot15(&mut self) -> Ot15W<GpioaOtyperSpec> {
        Ot15W::new(self, 15)
    }
}
...
pub struct GpioaOtyperSpec;
impl crate::RegisterSpec for GpioaOtyperSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioa_otyper::R`](R) reader structure"]
impl crate::Readable for GpioaOtyperSpec {}
#[doc = "`write(|w| ..)` method takes [`gpioa_otyper::W`](W) writer structure"]
impl crate::Writable for GpioaOtyperSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIOA_OTYPER to value 0"]
impl crate::Resettable for GpioaOtyperSpec {
