...
pub type R = crate::R<DmamuxC10crSpec>;
#[doc = "Register `DMAMUX_C10CR` writer"]
pub type W = crate::W<DmamuxC10crSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmareq_id(&mut self) -> DmareqIdW<DmamuxC10crSpec> {
        DmareqIdW::new(self, 0)
    }
    #[doc = "Bit 8 - Synchronization overrun interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn soie(&mut self) -> SoieW<DmamuxC10crSpec> {
        SoieW::new(self, 8)
    }
    #[doc = "Bit 9 - Event generation enable"]
    #[inline(always)]
    #[must_use]
    pub fn ege(&mut self) -> EgeW<DmamuxC10crSpec> {
        EgeW::new(self, 9)
    }
    #[doc = "Bit 16 - Synchronization enable"]
    #[inline(always)]
    #[must_use]
    pub fn se(&mut self) -> SeW<DmamuxC10crSpec> {
        SeW::new(self, 16)
    }
    #[doc = "Bits 17:18 - Synchronization polarity Defines the edge polarity of the selected synchronization input:"]
    #[inline(always)]
    #[must_use]
    pub fn spol(&mut self) -> SpolW<DmamuxC10crSpec> {
        SpolW::new(self, 17)
    }
    #[doc = "Bits 19:23 - Number of DMA requests minus 1 to forward Defines the number of DMA requests to forward to the DMA controller after a synchronization event, and/or the number of DMA requests before an output event is generated. This field must only be written when both SE and EGE bits are low."]
    #[inline(always)]
    #[must_use]
    pub fn nbreq(&mut self) -> NbreqW<DmamuxC10crSpec> {
        NbreqW::new(self, 19)
    }
    #[doc = "Bits 24:28 - Synchronization identification Selects the synchronization input (see Table137: DMAMUX: assignment of synchronization inputs to resources)."]
    #[inline(always)]
    #[must_use]
    pub fn sync_id(&mut self) -> SyncIdW<DmamuxC10crSpec> {
        SyncIdW::new(self, 24)
    }
}
...
pub struct DmamuxC10crSpec;
impl crate::RegisterSpec for DmamuxC10crSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dmamux_c10cr::R`](R) reader structure"]
impl crate::Readable for DmamuxC10crSpec {}
#[doc = "`write(|w| ..)` method takes [`dmamux_c10cr::W`](W) writer structure"]
impl crate::Writable for DmamuxC10crSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DMAMUX_C10CR to value 0"]
impl crate::Resettable for DmamuxC10crSpec {
