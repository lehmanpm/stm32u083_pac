...
pub type W = crate::W<GpioeBrrSpec>;
...
pub struct GpioeBrrSpec;
impl crate::RegisterSpec for GpioeBrrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`gpioe_brr::W`](W) writer structure"]
impl crate::Writable for GpioeBrrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIOE_BRR to value 0"]
impl crate::Resettable for GpioeBrrSpec {
