...
pub type R = crate::R<LpuartPrescSpec>;
#[doc = "Register `LPUART_PRESC` writer"]
pub type W = crate::W<LpuartPrescSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn prescaler(&mut self) -> PrescalerW<LpuartPrescSpec> {
        PrescalerW::new(self, 0)
    }
}
#[doc = "LPUART prescaler register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lpuart_presc::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lpuart_presc::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LpuartPrescSpec;
impl crate::RegisterSpec for LpuartPrescSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lpuart_presc::R`](R) reader structure"]
impl crate::Readable for LpuartPrescSpec {}
#[doc = "`write(|w| ..)` method takes [`lpuart_presc::W`](W) writer structure"]
impl crate::Writable for LpuartPrescSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPUART_PRESC to value 0"]
impl crate::Resettable for LpuartPrescSpec {
