...
pub type W = crate::W<AesKeyr4Spec>;
...
bitfield and for information relative to writing AES_KEYRx registers."]
    #[inline(always)]
    #[must_use]
    pub fn key(&mut self) -> KeyW<AesKeyr4Spec> {
        KeyW::new(self, 0)
    }
}
#[doc = "AES key register 4\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`aes_keyr4::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AesKeyr4Spec;
impl crate::RegisterSpec for AesKeyr4Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`aes_keyr4::W`](W) writer structure"]
impl crate::Writable for AesKeyr4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets AES_KEYR4 to value 0"]
impl crate::Resettable for AesKeyr4Spec {
