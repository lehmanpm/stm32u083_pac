#[doc = "Register `LPTIM2_ICR_INPUT` writer"]
pub type W = crate::W<Lptim2IcrInputSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn arrokcf(&mut self) -> ArrokcfW<Lptim2IcrInputSpec> {
        ArrokcfW::new(self, 4)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn upcf(&mut self) -> UpcfW<Lptim2IcrInputSpec> {
        UpcfW::new(self, 5)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc2cf(&mut self) -> Cc2cfW<Lptim2IcrInputSpec> {
        Cc2cfW::new(self, 9)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc3cf(&mut self) -> Cc3cfW<Lptim2IcrInputSpec> {
        Cc3cfW::new(self, 10)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc4cf(&mut self) -> Cc4cfW<Lptim2IcrInputSpec> {
        Cc4cfW::new(self, 11)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc1ocf(&mut self) -> Cc1ocfW<Lptim2IcrInputSpec> {
        Cc1ocfW::new(self, 12)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc2ocf(&mut self) -> Cc2ocfW<Lptim2IcrInputSpec> {
        Cc2ocfW::new(self, 13)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc3ocf(&mut self) -> Cc3ocfW<Lptim2IcrInputSpec> {
        Cc3ocfW::new(self, 14)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc4ocf(&mut self) -> Cc4ocfW<Lptim2IcrInputSpec> {
        Cc4ocfW::new(self, 15)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn dierokcf(&mut self) -> DierokcfW<Lptim2IcrInputSpec> {
        DierokcfW::new(self, 24)
    }
}
#[doc = "LPTIM2 interrupt clear register \\[alternate\\]\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lptim2_icr_input::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lptim2IcrInputSpec;
impl crate::RegisterSpec for Lptim2IcrInputSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`lptim2_icr_input::W`](W) writer structure"]
impl crate::Writable for Lptim2IcrInputSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPTIM2_ICR_INPUT to value 0"]
impl crate::Resettable for Lptim2IcrInputSpec {
