#[doc = "Register `LPTIM2_ISR_OUTPUT` reader"]
pub type R = crate::R<Lptim2IsrOutputSpec>;
...
#[doc = "LPTIM2 interrupt and status register \\[alternate\\]\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lptim2_isr_output::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lptim2IsrOutputSpec;
impl crate::RegisterSpec for Lptim2IsrOutputSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lptim2_isr_output::R`](R) reader structure"]
impl crate::Readable for Lptim2IsrOutputSpec {}
#[doc = "`reset()` method sets LPTIM2_ISR_OUTPUT to value 0"]
impl crate::Resettable for Lptim2IsrOutputSpec {
