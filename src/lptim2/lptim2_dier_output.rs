#[doc = "Register `LPTIM2_DIER_OUTPUT` reader"]
pub type R = crate::R<Lptim2DierOutputSpec>;
#[doc = "Register `LPTIM2_DIER_OUTPUT` writer"]
pub type W = crate::W<Lptim2DierOutputSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc1ie(&mut self) -> Cc1ieW<Lptim2DierOutputSpec> {
        Cc1ieW::new(self, 0)
    }
    #[doc = "Bit 1 - Autoreload match Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn arrmie(&mut self) -> ArrmieW<Lptim2DierOutputSpec> {
        ArrmieW::new(self, 1)
    }
    #[doc = "Bit 2 - External trigger valid edge Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn exttrigie(&mut self) -> ExttrigieW<Lptim2DierOutputSpec> {
        ExttrigieW::new(self, 2)
    }
    #[doc = "Bit 3 - Compare register 1 update OK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp1okie(&mut self) -> Cmp1okieW<Lptim2DierOutputSpec> {
        Cmp1okieW::new(self, 3)
    }
    #[doc = "Bit 4 - Autoreload register update OK Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn arrokie(&mut self) -> ArrokieW<Lptim2DierOutputSpec> {
        ArrokieW::new(self, 4)
    }
    #[doc = "Bit 5 - Direction change to UP Interrupt Enable Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn upie(&mut self) -> UpieW<Lptim2DierOutputSpec> {
        UpieW::new(self, 5)
    }
    #[doc = "Bit 6 - Direction change to down Interrupt Enable Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn downie(&mut self) -> DownieW<Lptim2DierOutputSpec> {
        DownieW::new(self, 6)
    }
    #[doc = "Bit 7 - Update event interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ueie(&mut self) -> UeieW<Lptim2DierOutputSpec> {
        UeieW::new(self, 7)
    }
    #[doc = "Bit 8 - Repetition register update OK interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn repokie(&mut self) -> RepokieW<Lptim2DierOutputSpec> {
        RepokieW::new(self, 8)
    }
    #[doc = "Bit 9 - Capture/compare 2 interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cc2ie(&mut self) -> Cc2ieW<Lptim2DierOutputSpec> {
        Cc2ieW::new(self, 9)
    }
    #[doc = "Bit 10 - Capture/compare 3 interrupt enable Note: If LPTIM does not implement at least 3 channels this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cc3ie(&mut self) -> Cc3ieW<Lptim2DierOutputSpec> {
        Cc3ieW::new(self, 10)
    }
    #[doc = "Bit 11 - Capture/compare 4 interrupt enable Note: If LPTIM does not implement at least 4 channels this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cc4ie(&mut self) -> Cc4ieW<Lptim2DierOutputSpec> {
        Cc4ieW::new(self, 11)
    }
    #[doc = "Bit 19 - Compare register 2 update OK interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cmp2okie(&mut self) -> Cmp2okieW<Lptim2DierOutputSpec> {
        Cmp2okieW::new(self, 19)
    }
    #[doc = "Bit 20 - Compare register 3 update OK interrupt enable Note: If LPTIM does not implement at least 3 channels this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cmp3okie(&mut self) -> Cmp3okieW<Lptim2DierOutputSpec> {
        Cmp3okieW::new(self, 20)
    }
    #[doc = "Bit 21 - Compare register 4 update OK interrupt enable Note: If LPTIM does not implement at least 4 channels this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn cmp4okie(&mut self) -> Cmp4okieW<Lptim2DierOutputSpec> {
        Cmp4okieW::new(self, 21)
    }
    #[doc = "Bit 23 - Update event DMA request enable Note: If LPTIM does not implement at least 1 channel this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn uede(&mut self) -> UedeW<Lptim2DierOutputSpec> {
        UedeW::new(self, 23)
    }
}
#[doc = "LPTIM2 interrupt enable register \\[alternate\\]\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lptim2_dier_output::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lptim2_dier_output::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lptim2DierOutputSpec;
impl crate::RegisterSpec for Lptim2DierOutputSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lptim2_dier_output::R`](R) reader structure"]
impl crate::Readable for Lptim2DierOutputSpec {}
#[doc = "`write(|w| ..)` method takes [`lptim2_dier_output::W`](W) writer structure"]
impl crate::Writable for Lptim2DierOutputSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPTIM2_DIER_OUTPUT to value 0"]
impl crate::Resettable for Lptim2DierOutputSpec {
