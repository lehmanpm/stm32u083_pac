#[doc = "Register `TSC_IOG2CR` reader"]
pub type R = crate::R<TscIog2crSpec>;
...
#[doc = "TSC I/O group 2 counter register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tsc_iog2cr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TscIog2crSpec;
impl crate::RegisterSpec for TscIog2crSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tsc_iog2cr::R`](R) reader structure"]
impl crate::Readable for TscIog2crSpec {}
#[doc = "`reset()` method sets TSC_IOG2CR to value 0"]
impl crate::Resettable for TscIog2crSpec {
