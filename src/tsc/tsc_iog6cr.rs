#[doc = "Register `TSC_IOG6CR` reader"]
pub type R = crate::R<TscIog6crSpec>;
...
#[doc = "TSC I/O group 6 counter register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tsc_iog6cr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TscIog6crSpec;
impl crate::RegisterSpec for TscIog6crSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tsc_iog6cr::R`](R) reader structure"]
impl crate::Readable for TscIog6crSpec {}
#[doc = "`reset()` method sets TSC_IOG6CR to value 0"]
impl crate::Resettable for TscIog6crSpec {
