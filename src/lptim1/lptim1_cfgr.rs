#[doc = "Register `LPTIM1_CFGR` reader"]
pub type R = crate::R<Lptim1CfgrSpec>;
#[doc = "Register `LPTIM1_CFGR` writer"]
pub type W = crate::W<Lptim1CfgrSpec>;
...
#[repr(u8)]
pub enum Trigsel {
    #[doc = "0: LPTIM1_ext_trig0"]
    B0x0 = 0,
    #[doc = "1: LPTIM1_ext_trig1"]
    B0x1 = 1,
    #[doc = "2: LPTIM1_ext_trig2"]
    B0x2 = 2,
    #[doc = "3: LPTIM1_ext_trig3"]
    B0x3 = 3,
    #[doc = "4: LPTIM1_ext_trig4"]
    B0x4 = 4,
    #[doc = "5: LPTIM1_ext_trig5"]
    B0x5 = 5,
    #[doc = "6: LPTIM1_ext_trig6"]
    B0x6 = 6,
    #[doc = "7: LPTIM1_ext_trig7"]
    B0x7 = 7,
}
...
impl TrigselR {
    ...
    #[doc = "LPTIM1_ext_trig0"]
    #[inline(always)]
    pub fn is_b_0x0(&self) -> bool {
        *self == Trigsel::B0x0
    }
    #[doc = "LPTIM1_ext_trig1"]
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == Trigsel::B0x1
    }
    #[doc = "LPTIM1_ext_trig2"]
    #[inline(always)]
    pub fn is_b_0x2(&self) -> bool {
        *self == Trigsel::B0x2
    }
    #[doc = "LPTIM1_ext_trig3"]
    #[inline(always)]
    pub fn is_b_0x3(&self) -> bool {
        *self == Trigsel::B0x3
    }
    #[doc = "LPTIM1_ext_trig4"]
    #[inline(always)]
    pub fn is_b_0x4(&self) -> bool {
        *self == Trigsel::B0x4
    }
    #[doc = "LPTIM1_ext_trig5"]
    #[inline(always)]
    pub fn is_b_0x5(&self) -> bool {
        *self == Trigsel::B0x5
    }
    #[doc = "LPTIM1_ext_trig6"]
    #[inline(always)]
    pub fn is_b_0x6(&self) -> bool {
        *self == Trigsel::B0x6
    }
    #[doc = "LPTIM1_ext_trig7"]
    #[inline(always)]
    pub fn is_b_0x7(&self) -> bool {
        *self == Trigsel::B0x7
    }
...
#[doc = "Registers update mode The PRELOAD bit controls the LPTIM1_ARR, LPTIM1_RCR and the LPTIM1_CCRx registers update modality\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Preload {
...
#[doc = "Field `PRELOAD` reader - Registers update mode The PRELOAD bit controls the LPTIM1_ARR, LPTIM1_RCR and the LPTIM1_CCRx registers update modality"]
...
#[doc = "Field `PRELOAD` writer - Registers update mode The PRELOAD bit controls the LPTIM1_ARR, LPTIM1_RCR and the LPTIM1_CCRx registers update modality"]
...
impl R {
    ...
    #[doc = "Bit 22 - Registers update mode The PRELOAD bit controls the LPTIM1_ARR, LPTIM1_RCR and the LPTIM1_CCRx registers update modality"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cksel(&mut self) -> CkselW<Lptim1CfgrSpec> {
        CkselW::new(self, 0)
    }
    #[doc = "Bits 1:2 - Clock Polarity When the LPTIM is clocked by an external clock source, CKPOL bits is used to configure the active edge or edges used by the counter: If the LPTIM is configured in Encoder mode (ENC bit is set), the encoder sub-mode 1 is active. If the LPTIM is configured in Encoder mode (ENC bit is set), the encoder sub-mode 2 is active. If the LPTIM is configured in Encoder mode (ENC bit is set), the encoder sub-mode 3 is active. Refer to Section125.4.15: Encoder mode for more details about Encoder mode sub-modes."]
    #[inline(always)]
    #[must_use]
    pub fn ckpol(&mut self) -> CkpolW<Lptim1CfgrSpec> {
        CkpolW::new(self, 1)
    }
    #[doc = "Bits 3:4 - Configurable digital filter for external clock The CKFLT value sets the number of consecutive equal samples that are detected when a level change occurs on an external clock signal before it is considered as a valid level transition. An internal clock source must be present to use this feature"]
    #[inline(always)]
    #[must_use]
    pub fn ckflt(&mut self) -> CkfltW<Lptim1CfgrSpec> {
        CkfltW::new(self, 3)
    }
    #[doc = "Bits 6:7 - Configurable digital filter for trigger The TRGFLT value sets the number of consecutive equal samples that are detected when a level change occurs on an internal trigger before it is considered as a valid level transition. An internal clock source must be present to use this feature"]
    #[inline(always)]
    #[must_use]
    pub fn trgflt(&mut self) -> TrgfltW<Lptim1CfgrSpec> {
        TrgfltW::new(self, 6)
    }
    #[doc = "Bits 9:11 - Clock prescaler The PRESC bits configure the prescaler division factor. It can be one among the following division factors:"]
    #[inline(always)]
    #[must_use]
    pub fn presc(&mut self) -> PrescW<Lptim1CfgrSpec> {
        PrescW::new(self, 9)
    }
    #[doc = "Bits 13:15 - Trigger selector The TRIGSEL bits select the trigger source that serves as a trigger event for the LPTIM among the below 8 available sources: See Section125.4.3: LPTIM input and trigger mapping for details."]
    #[inline(always)]
    #[must_use]
    pub fn trigsel(&mut self) -> TrigselW<Lptim1CfgrSpec> {
        TrigselW::new(self, 13)
    }
    #[doc = "Bits 17:18 - Trigger enable and polarity The TRIGEN bits controls whether the LPTIM counter is started by an external trigger or not. If the external trigger option is selected, three configurations are possible for the trigger active edge:"]
    #[inline(always)]
    #[must_use]
    pub fn trigen(&mut self) -> TrigenW<Lptim1CfgrSpec> {
        TrigenW::new(self, 17)
    }
    #[doc = "Bit 19 - Timeout enable The TIMOUT bit controls the Timeout feature"]
    #[inline(always)]
    #[must_use]
    pub fn timout(&mut self) -> TimoutW<Lptim1CfgrSpec> {
        TimoutW::new(self, 19)
    }
    #[doc = "Bit 20 - Waveform shape The WAVE bit controls the output shape"]
    #[inline(always)]
    #[must_use]
    pub fn wave(&mut self) -> WaveW<Lptim1CfgrSpec> {
        WaveW::new(self, 20)
    }
    #[doc = "Bit 22 - Registers update mode The PRELOAD bit controls the LPTIM1_ARR, LPTIM1_RCR and the LPTIM1_CCRx registers update modality"]
    #[inline(always)]
    #[must_use]
    pub fn preload(&mut self) -> PreloadW<Lptim1CfgrSpec> {
        PreloadW::new(self, 22)
    }
    #[doc = "Bit 23 - counter mode enabled The COUNTMODE bit selects which clock source is used by the LPTIM to clock the counter:"]
    #[inline(always)]
    #[must_use]
    pub fn countmode(&mut self) -> CountmodeW<Lptim1CfgrSpec> {
        CountmodeW::new(self, 23)
    }
    #[doc = "Bit 24 - Encoder mode enable The ENC bit controls the Encoder mode Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section125.3."]
    #[inline(always)]
    #[must_use]
    pub fn enc(&mut self) -> EncW<Lptim1CfgrSpec> {
        EncW::new(self, 24)
    }
}
#[doc = "LPTIM configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lptim1_cfgr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lptim1_cfgr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lptim1CfgrSpec;
impl crate::RegisterSpec for Lptim1CfgrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lptim1_cfgr::R`](R) reader structure"]
impl crate::Readable for Lptim1CfgrSpec {}
#[doc = "`write(|w| ..)` method takes [`lptim1_cfgr::W`](W) writer structure"]
impl crate::Writable for Lptim1CfgrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPTIM1_CFGR to value 0"]
impl crate::Resettable for Lptim1CfgrSpec {
