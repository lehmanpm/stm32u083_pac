#[doc = "Register `LPTIM1_ISR_OUTPUT` reader"]
pub type R = crate::R<Lptim1IsrOutputSpec>;
...
#[doc = "LPTIM1 interrupt and status register \\[alternate\\]\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lptim1_isr_output::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lptim1IsrOutputSpec;
impl crate::RegisterSpec for Lptim1IsrOutputSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lptim1_isr_output::R`](R) reader structure"]
impl crate::Readable for Lptim1IsrOutputSpec {}
#[doc = "`reset()` method sets LPTIM1_ISR_OUTPUT to value 0"]
impl crate::Resettable for Lptim1IsrOutputSpec {
