#[doc = "Register `LPTIM1_ICR_INPUT` writer"]
pub type W = crate::W<Lptim1IcrInputSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn arrokcf(&mut self) -> ArrokcfW<Lptim1IcrInputSpec> {
        ArrokcfW::new(self, 4)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn upcf(&mut self) -> UpcfW<Lptim1IcrInputSpec> {
        UpcfW::new(self, 5)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc2cf(&mut self) -> Cc2cfW<Lptim1IcrInputSpec> {
        Cc2cfW::new(self, 9)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc3cf(&mut self) -> Cc3cfW<Lptim1IcrInputSpec> {
        Cc3cfW::new(self, 10)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc4cf(&mut self) -> Cc4cfW<Lptim1IcrInputSpec> {
        Cc4cfW::new(self, 11)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc1ocf(&mut self) -> Cc1ocfW<Lptim1IcrInputSpec> {
        Cc1ocfW::new(self, 12)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc2ocf(&mut self) -> Cc2ocfW<Lptim1IcrInputSpec> {
        Cc2ocfW::new(self, 13)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc3ocf(&mut self) -> Cc3ocfW<Lptim1IcrInputSpec> {
        Cc3ocfW::new(self, 14)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc4ocf(&mut self) -> Cc4ocfW<Lptim1IcrInputSpec> {
        Cc4ocfW::new(self, 15)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn dierokcf(&mut self) -> DierokcfW<Lptim1IcrInputSpec> {
        DierokcfW::new(self, 24)
    }
}
#[doc = "LPTIM1 interrupt clear register \\[alternate\\]\n\nYou can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lptim1_icr_input::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lptim1IcrInputSpec;
impl crate::RegisterSpec for Lptim1IcrInputSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`lptim1_icr_input::W`](W) writer structure"]
impl crate::Writable for Lptim1IcrInputSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPTIM1_ICR_INPUT to value 0"]
impl crate::Resettable for Lptim1IcrInputSpec {
