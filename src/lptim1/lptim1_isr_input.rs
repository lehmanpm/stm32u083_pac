#[doc = "Register `LPTIM1_ISR_INPUT` reader"]
pub type R = crate::R<Lptim1IsrInputSpec>;
...
#[doc = "LPTIM1 interrupt and status register \\[alternate\\]\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lptim1_isr_input::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lptim1IsrInputSpec;
impl crate::RegisterSpec for Lptim1IsrInputSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lptim1_isr_input::R`](R) reader structure"]
impl crate::Readable for Lptim1IsrInputSpec {}
#[doc = "`reset()` method sets LPTIM1_ISR_INPUT to value 0"]
impl crate::Resettable for Lptim1IsrInputSpec {
