#[doc = "Register `LPTIM1_CFGR2` reader"]
pub type R = crate::R<Lptim1Cfgr2Spec>;
#[doc = "Register `LPTIM1_CFGR2` writer"]
pub type W = crate::W<Lptim1Cfgr2Spec>;
...
#[repr(u8)]
pub enum In1sel {
    #[doc = "0: LPTIM1_in1_mux0"]
    B0x0 = 0,
    #[doc = "1: LPTIM1_in1_mux1"]
    B0x1 = 1,
    #[doc = "2: LPTIM1_in1_mux2"]
    B0x2 = 2,
    #[doc = "3: LPTIM1_in1_mux3"]
    B0x3 = 3,
}
...
#[repr(u8)]
pub enum In2sel {
    #[doc = "0: LPTIM1_in2_mux0"]
    B0x0 = 0,
    #[doc = "1: LPTIM1_in2_mux1"]
    B0x1 = 1,
    #[doc = "2: LPTIM1_in2_mux2"]
    B0x2 = 2,
    #[doc = "3: LPTIM1_in2_mux3"]
    B0x3 = 3,
}
...
#[repr(u8)]
pub enum Ic1sel {
    #[doc = "0: LPTIM1_ic1_mux0"]
    B0x0 = 0,
    #[doc = "1: LPTIM1_ic1_mux1"]
    B0x1 = 1,
    #[doc = "2: LPTIM1_ic1_mux2"]
    B0x2 = 2,
    #[doc = "3: LPTIM1_ic1_mux3"]
    B0x3 = 3,
}
...
#[repr(u8)]
pub enum Ic2sel {
    #[doc = "0: LPTIM1_ic2_mux0"]
    B0x0 = 0,
    #[doc = "1: LPTIM1_ic2_mux1"]
    B0x1 = 1,
    #[doc = "2: LPTIM1_ic2_mux2"]
    B0x2 = 2,
    #[doc = "3: LPTIM1_ic2_mux3"]
    B0x3 = 3,
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn in1sel(&mut self) -> In1selW<Lptim1Cfgr2Spec> {
        In1selW::new(self, 0)
    }
    #[doc = "Bits 4:5 - LPTIM input 2 selection The IN2SEL bits control the LPTIM input 2 multiplexer, which connects LPTIM input 2 to one of the available inputs. For connection details refer to Section125.4.3: LPTIM input and trigger mapping."]
    #[inline(always)]
    #[must_use]
    pub fn in2sel(&mut self) -> In2selW<Lptim1Cfgr2Spec> {
        In2selW::new(self, 4)
    }
    #[doc = "Bits 16:17 - LPTIM input capture 1 selection The IC1SEL bits control the LPTIM Input capture 1 multiplexer, which connects LPTIM Input capture 1 to one of the available inputs. For connection details refer to Section125.4.3: LPTIM input and trigger mapping."]
    #[inline(always)]
    #[must_use]
    pub fn ic1sel(&mut self) -> Ic1selW<Lptim1Cfgr2Spec> {
        Ic1selW::new(self, 16)
    }
    #[doc = "Bits 20:21 - LPTIM input capture 2 selection The IC2SEL bits control the LPTIM Input capture 2 multiplexer, which connects LPTIM Input capture 2 to one of the available inputs. For connection details refer to Section125.4.3: LPTIM input and trigger mapping."]
    #[inline(always)]
    #[must_use]
    pub fn ic2sel(&mut self) -> Ic2selW<Lptim1Cfgr2Spec> {
        Ic2selW::new(self, 20)
    }
}
#[doc = "LPTIM configuration register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lptim1_cfgr2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lptim1_cfgr2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lptim1Cfgr2Spec;
impl crate::RegisterSpec for Lptim1Cfgr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`lptim1_cfgr2::R`](R) reader structure"]
impl crate::Readable for Lptim1Cfgr2Spec {}
#[doc = "`write(|w| ..)` method takes [`lptim1_cfgr2::W`](W) writer structure"]
impl crate::Writable for Lptim1Cfgr2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets LPTIM1_CFGR2 to value 0"]
impl crate::Resettable for Lptim1Cfgr2Spec {
