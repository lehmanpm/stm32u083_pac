...
pub type R = crate::R<Tim7DierSpec>;
#[doc = "Register `TIM7_DIER` writer"]
pub type W = crate::W<Tim7DierSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uie(&mut self) -> UieW<Tim7DierSpec> {
        UieW::new(self, 0)
    }
    #[doc = "Bit 8 - Update DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn ude(&mut self) -> UdeW<Tim7DierSpec> {
        UdeW::new(self, 8)
    }
}
...
pub struct Tim7DierSpec;
impl crate::RegisterSpec for Tim7DierSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`tim7_dier::R`](R) reader structure"]
impl crate::Readable for Tim7DierSpec {}
#[doc = "`write(|w| ..)` method takes [`tim7_dier::W`](W) writer structure"]
impl crate::Writable for Tim7DierSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets TIM7_DIER to value 0"]
impl crate::Resettable for Tim7DierSpec {
