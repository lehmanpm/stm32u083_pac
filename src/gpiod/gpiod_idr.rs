...
pub type R = crate::R<GpiodIdrSpec>;
...
pub struct GpiodIdrSpec;
impl crate::RegisterSpec for GpiodIdrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiod_idr::R`](R) reader structure"]
impl crate::Readable for GpiodIdrSpec {}
#[doc = "`reset()` method sets GPIOD_IDR to value 0"]
impl crate::Resettable for GpiodIdrSpec {
