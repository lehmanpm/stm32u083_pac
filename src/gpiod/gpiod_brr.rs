...
pub type W = crate::W<GpiodBrrSpec>;
...
pub struct GpiodBrrSpec;
impl crate::RegisterSpec for GpiodBrrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`gpiod_brr::W`](W) writer structure"]
impl crate::Writable for GpiodBrrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIOD_BRR to value 0"]
impl crate::Resettable for GpiodBrrSpec {
