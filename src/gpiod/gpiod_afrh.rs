...
pub type R = crate::R<GpiodAfrhSpec>;
#[doc = "Register `GPIOD_AFRH` writer"]
pub type W = crate::W<GpiodAfrhSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn afsel8(&mut self) -> Afsel8W<GpiodAfrhSpec> {
        Afsel8W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel9(&mut self) -> Afsel9W<GpiodAfrhSpec> {
        Afsel9W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel10(&mut self) -> Afsel10W<GpiodAfrhSpec> {
        Afsel10W::new(self, 8)
    }
    #[doc = "Bits 12:15 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel11(&mut self) -> Afsel11W<GpiodAfrhSpec> {
        Afsel11W::new(self, 12)
    }
    #[doc = "Bits 16:19 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel12(&mut self) -> Afsel12W<GpiodAfrhSpec> {
        Afsel12W::new(self, 16)
    }
    #[doc = "Bits 20:23 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel13(&mut self) -> Afsel13W<GpiodAfrhSpec> {
        Afsel13W::new(self, 20)
    }
    #[doc = "Bits 24:27 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel14(&mut self) -> Afsel14W<GpiodAfrhSpec> {
        Afsel14W::new(self, 24)
    }
    #[doc = "Bits 28:31 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel15(&mut self) -> Afsel15W<GpiodAfrhSpec> {
...
pub struct GpiodAfrhSpec;
impl crate::RegisterSpec for GpiodAfrhSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiod_afrh::R`](R) reader structure"]
impl crate::Readable for GpiodAfrhSpec {}
#[doc = "`write(|w| ..)` method takes [`gpiod_afrh::W`](W) writer structure"]
impl crate::Writable for GpiodAfrhSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIOD_AFRH to value 0"]
impl crate::Resettable for GpiodAfrhSpec {
