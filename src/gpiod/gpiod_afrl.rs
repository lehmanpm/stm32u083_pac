...
pub type R = crate::R<GpiodAfrlSpec>;
#[doc = "Register `GPIOD_AFRL` writer"]
pub type W = crate::W<GpiodAfrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn afsel0(&mut self) -> Afsel0W<GpiodAfrlSpec> {
        Afsel0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel1(&mut self) -> Afsel1W<GpiodAfrlSpec> {
        Afsel1W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel2(&mut self) -> Afsel2W<GpiodAfrlSpec> {
        Afsel2W::new(self, 8)
    }
    #[doc = "Bits 12:15 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel3(&mut self) -> Afsel3W<GpiodAfrlSpec> {
        Afsel3W::new(self, 12)
    }
    #[doc = "Bits 16:19 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel4(&mut self) -> Afsel4W<GpiodAfrlSpec> {
        Afsel4W::new(self, 16)
    }
    #[doc = "Bits 20:23 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel5(&mut self) -> Afsel5W<GpiodAfrlSpec> {
        Afsel5W::new(self, 20)
    }
    #[doc = "Bits 24:27 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel6(&mut self) -> Afsel6W<GpiodAfrlSpec> {
        Afsel6W::new(self, 24)
    }
    #[doc = "Bits 28:31 - Alternate function selection for port x I/O pin y These bits are written by software to configure alternate function I/Os."]
    #[inline(always)]
    #[must_use]
    pub fn afsel7(&mut self) -> Afsel7W<GpiodAfrlSpec> {
        Afsel7W::new(self, 28)
    }
}
...
pub struct GpiodAfrlSpec;
impl crate::RegisterSpec for GpiodAfrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpiod_afrl::R`](R) reader structure"]
impl crate::Readable for GpiodAfrlSpec {}
#[doc = "`write(|w| ..)` method takes [`gpiod_afrl::W`](W) writer structure"]
impl crate::Writable for GpiodAfrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIOD_AFRL to value 0"]
impl crate::Resettable for GpiodAfrlSpec {
