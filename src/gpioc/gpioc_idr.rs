...
pub type R = crate::R<GpiocIdrSpec>;
...
pub struct GpiocIdrSpec;
impl crate::RegisterSpec for GpiocIdrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpioc_idr::R`](R) reader structure"]
impl crate::Readable for GpiocIdrSpec {}
#[doc = "`reset()` method sets GPIOC_IDR to value 0"]
impl crate::Resettable for GpiocIdrSpec {
