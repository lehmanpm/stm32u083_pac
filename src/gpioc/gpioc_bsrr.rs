...
pub type W = crate::W<GpiocBsrrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn br0(&mut self) -> Br0W<GpiocBsrrSpec> {
        Br0W::new(self, 16)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br1(&mut self) -> Br1W<GpiocBsrrSpec> {
        Br1W::new(self, 17)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br2(&mut self) -> Br2W<GpiocBsrrSpec> {
        Br2W::new(self, 18)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br3(&mut self) -> Br3W<GpiocBsrrSpec> {
        Br3W::new(self, 19)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br4(&mut self) -> Br4W<GpiocBsrrSpec> {
        Br4W::new(self, 20)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br5(&mut self) -> Br5W<GpiocBsrrSpec> {
        Br5W::new(self, 21)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br6(&mut self) -> Br6W<GpiocBsrrSpec> {
        Br6W::new(self, 22)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br7(&mut self) -> Br7W<GpiocBsrrSpec> {
        Br7W::new(self, 23)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br8(&mut self) -> Br8W<GpiocBsrrSpec> {
        Br8W::new(self, 24)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br9(&mut self) -> Br9W<GpiocBsrrSpec> {
        Br9W::new(self, 25)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br10(&mut self) -> Br10W<GpiocBsrrSpec> {
        Br10W::new(self, 26)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br11(&mut self) -> Br11W<GpiocBsrrSpec> {
        Br11W::new(self, 27)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br12(&mut self) -> Br12W<GpiocBsrrSpec> {
        Br12W::new(self, 28)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br13(&mut self) -> Br13W<GpiocBsrrSpec> {
        Br13W::new(self, 29)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br14(&mut self) -> Br14W<GpiocBsrrSpec> {
        Br14W::new(self, 30)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn br15(&mut self) -> Br15W<GpiocBsrrSpec> {
        Br15W::new(self, 31)
    }
}
...
pub struct GpiocBsrrSpec;
impl crate::RegisterSpec for GpiocBsrrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`gpioc_bsrr::W`](W) writer structure"]
impl crate::Writable for GpiocBsrrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIOC_BSRR to value 0"]
impl crate::Resettable for GpiocBsrrSpec {
