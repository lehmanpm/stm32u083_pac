...
pub type W = crate::W<GpiocBrrSpec>;
...
pub struct GpiocBrrSpec;
impl crate::RegisterSpec for GpiocBrrSpec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`gpioc_brr::W`](W) writer structure"]
impl crate::Writable for GpiocBrrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPIOC_BRR to value 0"]
impl crate::Resettable for GpiocBrrSpec {
